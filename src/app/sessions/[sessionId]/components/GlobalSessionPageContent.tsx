...
import { useAliveTask } from "@/app/projects/[projectId]/sessions/[sessionId]/hooks/useAliveTask";
import { useSession } from "@/app/projects/[projectId]/sessions/[sessionId]/hooks/useSession";
import { useSessionCwd } from "@/app/projects/[projectId]/sessions/[sessionId]/hooks/useSessionCwd";
import { useSessionPermissionMode } from "@/app/projects/[projectId]/sessions/[sessionId]/hooks/useSessionPermissionMode";
import { ConversationList } from "@/app/projects/[projectId]/sessions/[sessionId]/components/conversationList/ConversationList";
import { DiffModal } from "@/app/projects/[projectId]/sessions/[sessionId]/components/diffModal";
import { ResumeChat, type ResumeChatRef } from "@/app/projects/[projectId]/sessions/[sessionId]/components/resumeChat/ResumeChat";
import { GlobalSessionsSidebar, type GlobalSessionsTabRef } from "./GlobalSessionsSidebar";

export const GlobalSessionPageContent: FC<{
  projectId: string;
  sessionId: string;
}> = ({ projectId, sessionId }) => {
  ...
  useGlobalKeyboardShortcuts({
    onNavigateUp: () => {
      globalSessionsSidebarRef.current?.navigateUp();
    },
    onNavigateDown: () => {
      globalSessionsSidebarRef.current?.navigateDown();
    },
    onCreateNew: () => {
      globalSessionsSidebarRef.current?.createNew();
    },
    onOpenEditor: () => {
      if (sessionCwd) {
  ...
  const globalSessionsSidebarRef = useRef<GlobalSessionsTabRef>(null);
  ...
  // Auto-scroll on initial mount after conversations render
  useEffect(() => {
